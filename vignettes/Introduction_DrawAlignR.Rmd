...
```{r}
          ...
          lib_input <- "../inst/extdata/pqp/psgs_phospho_optimized_decoys.pqp"
          peptide <- "ANS(UniMod:21)SPTTNIDHLK(UniMod:259)"
          lib <- mstools::getPepLibData_(lib_input, peptide_id = '')
          g.out <- mstools::getXIC(graphic_obj = ggplot(), chromatogram_file = chrom_input,
